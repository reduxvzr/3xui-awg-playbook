...
curl --max-time 25 -so $filter_path/ruAdguard.txt https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_1_Russian/filter.txt
curl --max-time 25 -so $filter_path/shakal.txt https://schakal.ru/hosts/hosts.txt
curl --max-time 25 -so $filter_path/stevenBlack.txt https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts
